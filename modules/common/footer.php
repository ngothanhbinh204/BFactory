...
<footer class="footer">
        ...
        <div class="container">
            <div class="row footer-row">
                <div class="col footer-left lg:w-5/12">
                    <div class="footer-logo"><a href="<?= home_url() ?>"><img class="lozad" data-src="<?= $footer_logo ?>" alt="" /></a></div>
                    <p class="footer-tagline"><?= $footer_tagline ?></p>
                    <div class="footer-partner"><span class="partner-label"><?= $footer_partner_label ?></span><a
                            class="partner-logo-box" href="<?= $footer_partner_url ?>" target="_blank" rel="noopener"><img class="lozad"
                                data-src="<?= $footer_partner_logo ?>" alt="" /></a></div>
                    <ul class="footer-socials">
                        <?php if ($footer_socials): ?>
                            ...
                            ?>
                            <li><a href="<?= esc_url($link_url) ?>" aria-label="<?= esc_attr($link_title) ?>" target="<?= esc_attr($link_target) ?>" rel="noopener"><span class="icon"><i
                ...
                <div class="col footer-right lg:w-7/12">
                    ...
                    <div class="footer-info-block">
                        <div class="info-text"><?= $footer_working_hours ?></div><a
                            class="info-email"
    ...
    <div class="tool-fixed-cta">
        ...
        <?php if ($cta_phone) : ?>
        <a class="btn-slide btn-phone" href="tel:<?= preg_replace('/[^0-9]/', '', strip_tags($cta_phone)) ?>">
            <div class="btn-icon"><i class="fa-light fa-phone"></i></div>
            <div class="btn-content"><span><?= wp_kses_post($cta_phone) ?></span></div>
        </a>
        <?php endif; ?>
            ...
            <div class="btn-content">
                <ul>
                    <?php foreach ($cta_socials as $social) : ?>
                        <li><a href="<?= esc_url($social['link']) ?>" target="_blank" rel="noopener"><i class="<?= esc_attr($social['icon']) ?>"></i></a></li>
                    <?php endforeach; ?>
                </ul>
            </div>
        </div>

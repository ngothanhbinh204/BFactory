...
require get_template_directory() . '/inc/function-snippet.php';
require get_template_directory() . '/inc/function-walker.php';
require get_template_directory() . '/inc/function-copyright.php';
require get_template_directory() . '/inc/function-woo.php';
require get_template_directory() . '/inc/function-addtocart.php';
